...
BasePlusCommissionEmployee::BasePlusCommissionEmployee(
   ...
   : date(first, last, ssn, sales, rate)
...
void BasePlusCommissionEmployee::setSocialSecurityNumber(
   const string &ssn )
{
   date setSocialSecurityNumber(ssn);
...
{
   return date.getSocialSecurityNumber();
...
{
   return getBaseSalary() + date.earnings();
